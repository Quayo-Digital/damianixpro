...
-- Create sample document templates (only when we have a valid created_by user)
DO $$
DECLARE
  v_created_by UUID;
BEGIN
  SELECT id INTO v_created_by FROM auth.users WHERE raw_user_meta_data->>'role' = 'admin' LIMIT 1;
  IF v_created_by IS NULL THEN
    SELECT id INTO v_created_by FROM auth.users ORDER BY created_at LIMIT 1;
  END IF;
  IF v_created_by IS NOT NULL THEN
    INSERT INTO document_templates (template_name, document_type, template_fields, validation_rules, created_by) VALUES
    ('Nigerian Lease Agreement Template', 'lease_agreement',
     '[{"field_id": "landlord_name", "field_name": "Landlord Name", "field_type": "text", "is_required": true},{"field_id": "tenant_name", "field_name": "Tenant Name", "field_type": "text", "is_required": true},{"field_id": "property_address", "field_name": "Property Address", "field_type": "text", "is_required": true},{"field_id": "monthly_rent", "field_name": "Monthly Rent", "field_type": "currency", "is_required": true},{"field_id": "lease_start", "field_name": "Lease Start Date", "field_type": "date", "is_required": true},{"field_id": "lease_end", "field_name": "Lease End Date", "field_type": "date", "is_required": true},{"field_id": "security_deposit", "field_name": "Security Deposit", "field_type": "currency", "is_required": true}]',
     '[{"rule_id": "rent_required", "rule_name": "Rent Amount Required", "rule_type": "required_field", "is_critical": true},{"rule_id": "date_validation", "rule_name": "Valid Date Range", "rule_type": "date_validation", "is_critical": true}]',
     v_created_by),
    ('Nigerian ID Card Template', 'id_card',
     '[{"field_id": "full_name", "field_name": "Full Name", "field_type": "text", "is_required": true},{"field_id": "nin", "field_name": "National Identification Number", "field_type": "text", "is_required": true, "validation_pattern": "^\\d{11}$"},{"field_id": "date_of_birth", "field_name": "Date of Birth", "field_type": "date", "is_required": true},{"field_id": "place_of_birth", "field_name": "Place of Birth", "field_type": "text", "is_required": true},{"field_id": "gender", "field_name": "Gender", "field_type": "select", "options": ["Male", "Female"], "is_required": true},{"field_id": "address", "field_name": "Address", "field_type": "text", "is_required": true}]',
     '[{"rule_id": "nin_format", "rule_name": "Valid NIN Format", "rule_type": "format_check", "is_critical": true},{"rule_id": "name_required", "rule_name": "Full Name Required", "rule_type": "required_field", "is_critical": true}]',
     v_created_by)
