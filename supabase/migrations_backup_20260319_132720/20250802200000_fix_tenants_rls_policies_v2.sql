-- Fix Tenants Table RLS Policies - Version 2
-- More robust approach to handle authentication issues

-- Skip is_admin replacement - use existing function (parameter name must match)
...
-- Ensure SELECT policies allow proper access
...
DO $$
BEGIN
    RAISE NOTICE 'Tenants table RLS policies have been updated with more robust authentication handling.';
END $$;
