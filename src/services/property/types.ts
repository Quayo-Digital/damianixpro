...
export const propertyFormSchema = z.object({
  ...
  development_status: z
    .enum(['RAW_LAND', 'SURVEYED', 'TITLED', 'DEVELOPED', 'UNDER_DEVELOPMENT'])
    .optional(),
...
/** Occupancy for estates / multi-unit listings (from RPC `get_property_lease_summaries`). */
...
export interface Property {
  ...
  created_at?: string;
  updated_at?: string;
  /** When loaded via `fetchProperties` + lease RPC (estates / occupancy). */
