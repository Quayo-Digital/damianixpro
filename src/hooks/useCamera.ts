...
import { cameraService, CameraCapabilities, CameraSettings, CapturedPhoto, CameraError } from '@/services/camera/CameraService';
...
export function useCamera(autoInitialize = false): UseCameraReturn {
  ...
  // Initialize camera
  const initializeCamera = useCallback(async (customSettings?: Partial<CameraSettings>) => {
