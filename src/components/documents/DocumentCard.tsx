        ...
        <DialogContent className="sm:max-w-4xl h-[85vh] flex flex-col">
          <div className="flex-1 overflow-hidden rounded-lg">
            {document.file_type.includes('pdf') ? (
              ...
              <div className="h-full flex items-center justify-center bg-muted rounded-lg overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (parent) {
                      parent.innerHTML = '<p class="text-muted-foreground">Failed to load image preview</p>';
                    }
                  }}
                />
              </div>
              ...
              <div className="h-full flex flex-col items-center justify-center bg-muted rounded-lg p-4">
