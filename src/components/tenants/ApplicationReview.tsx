...
export function ApplicationReview({ application, tenantName = 'Applicant' }: ApplicationReviewProps) {
  const [status, setStatus] = useState<'pending' | 'approved' | 'rejected'>(application?.status || 'pending');
      ...
      <Card>
          ...
          <div className="flex items-center space-x-4 mb-6">
            <Avatar className="h-16 w-16">
              <AvatarFallback className="text-lg">
                {applicationData.applicantName.split(' ').map(n => n[0]).join('')}
              </AvatarFallback>
            </Avatar>
            <div>
          ...
          <Tabs defaultValue="application" className="mt-6">
                  ...
                  <CardContent>
                    <dl className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <dd className="font-medium capitalize">{applicationData.employmentStatus}</dd>
                      </div>
            ...
            <TabsContent value="documents">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Review the applicant's submitted documentation
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="screening">
              <div className="space-y-6">
                ...
                <TenantScreening 
                  tenantId={"123"}
                  tenantName={applicationData.applicantName}
                />
              </div>
            </TabsContent>
          </Tabs>
        ...
        <CardFooter className="border-t px-6 py-4">
          {status === 'pending' ? (
            ...
            <div className="w-full text-center flex items-center justify-center text-green-500 font-medium">
              <CheckCircle className="mr-2 h-5 w-5" />
              Application approved
            </div>
          ) : (
            <div className="w-full text-center flex items-center justify-center text-destructive font-medium">
