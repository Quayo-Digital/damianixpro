            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewLeadData({ ...newLeadData, lead_source: value as any })
                  }
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewLeadData({ ...newLeadData, budget_min: parseInt(e.target.value) })
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewLeadData({ ...newLeadData, budget_max: parseInt(e.target.value) })
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewLeadData({ ...newLeadData, preferred_location: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewLeadData({ ...newLeadData, property_type: e.target.value })
                  }
            ...
            <div className="space-y-4">
              ...
              {selectedLead.notes && (
                <div>
                  ...
                  <p className="mt-1 rounded bg-gray-50 p-3 text-sm">{selectedLead.notes}</p>
                </div>
              )}
