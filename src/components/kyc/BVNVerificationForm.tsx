...
export const BVNVerificationForm: React.FC = () => {
  const { verifyBVN, isBvnVerifying, canPerformVerification, getVerificationUnavailableReason } =
    useNigerianApis();
  ...
  if (!canVerify) {
    return (
      <Alert>
        ...
        <AlertDescription>{getVerificationUnavailableReason('bvn')}</AlertDescription>
      </Alert>
    );
  }
      ...
      <CardContent className="p-6">
        <div className="space-y-6">
          ...
          <Alert>
            ...
            <AlertDescription>
              Your BVN is used to verify your identity. All information is encrypted and processed
              securely according to Nigerian banking regulations.
            </AlertDescription>
          </Alert>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">
                Your BVN can be found on your bank statement or by dialing *565*0# on your
            ...
            <div className="rounded-lg bg-yellow-50 p-3">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> Providing additional information (name, date of birth, phone)
                helps improve verification accuracy and may be required for some verification
                levels.
              </p>
            </div>

            <Button type="submit" disabled={isBvnVerifying} className="w-full">
              {isBvnVerifying ? (
