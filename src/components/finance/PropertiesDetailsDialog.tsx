      ...
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6 pb-4">
            ...
            <Card className="p-4">
              ...
              {worstProperty && (
                <div>
                  ...
                  <p className={`text-sm ${worstProperty.profit < 0 ? 'text-red-600' : 'text-amber-600'}`}>
          ...
          <div className="bg-white rounded-md p-4 border">
            <h2 className="text-lg font-semibold mb-4">Profit Distribution by Property</h2>
          ...
          <div className="bg-white rounded-md p-4 border">
            <h2 className="text-lg font-semibold mb-4">Property Financial Comparison</h2>
          ...
          <div className="bg-white rounded-md p-4 border">
            <h2 className="text-lg font-semibold mb-4">Property Performance Details</h2>
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  {propertyData.map((property) => {
                    const margin = property.revenue > 0 ? ((property.profit / property.revenue) * 100).toFixed(1) : '0.0';
                    return (
