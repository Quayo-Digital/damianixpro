    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <CardContent>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              {accounting.totalRevenue > 0
                ? Math.round((accounting.platformFees / accounting.totalRevenue) * 100)
                : 0}
              % of revenue
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ₦{accounting.agentCommissions.toLocaleString()}
            </div>
            <p className="mt-1 text-xs text-muted-foreground">
              {accounting.totalRevenue > 0
                ? Math.round((accounting.agentCommissions / accounting.totalRevenue) * 100)
                : 0}
              % of revenue
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">₦{accounting.pendingPayouts.toLocaleString()}</div>
          </CardContent>
        </Card>
      </div>
