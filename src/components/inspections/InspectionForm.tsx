...
const roomSections = [
  {
    id: 'living-room',
    title: 'Living Room',
    items: ['Walls', 'Ceiling', 'Floor/Carpet', 'Windows', 'Curtains/Blinds', 'Light Fixtures', 'Electrical Outlets']
  },
  {
    id: 'kitchen',
    title: 'Kitchen',
    items: ['Countertops', 'Cabinets', 'Sink', 'Faucet', 'Stove/Oven', 'Refrigerator', 'Dishwasher', 'Floor', 'Walls']
  },
  {
    id: 'bathroom',
    title: 'Bathroom',
    items: ['Sink', 'Toilet', 'Bathtub/Shower', 'Tiles', 'Floor', 'Mirror', 'Towel Rails', 'Exhaust Fan']
  },
  {
    id: 'bedroom',
    title: 'Bedroom',
    items: ['Walls', 'Ceiling', 'Floor/Carpet', 'Windows', 'Curtains/Blinds', 'Closet', 'Light Fixtures']
  },
  {
    id: 'exterior',
    title: 'Exterior & Misc',
    items: ['Front Door', 'Back Door', 'Patio/Balcony', 'Mailbox', 'Smoke Detectors', 'Carbon Monoxide Detectors']
  }
];
              ...
              <FormControl>
                ...
                >
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    ...
                    <FormLabel className="font-normal">Pass - Property meets all standards</FormLabel>
                  </FormItem>
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    <FormControl>
                      <RadioGroupItem value="conditional" />
                    </FormControl>
                    <FormLabel className="font-normal">Conditional - Minor issues to be addressed</FormLabel>
                  </FormItem>
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    <FormControl>
                      <RadioGroupItem value="fail" />
                    </FormControl>
                    <FormLabel className="font-normal">Fail - Major issues require attention</FormLabel>
                  </FormItem>
                </RadioGroup>
              </FormControl>
              <FormMessage />
