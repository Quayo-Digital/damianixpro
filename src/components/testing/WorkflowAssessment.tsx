    ...
    <Card>
      ...
      <CardContent>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex flex-1 items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            {step.details && (
                              <div className="mb-2 rounded border border-blue-200 bg-blue-50 p-2 text-sm">
                                <strong>Details:</strong> {step.details}
                              </div>
                            )}

                            {step.issues && step.issues.length > 0 && (
                              <div className="mb-2 rounded border border-red-200 bg-red-50 p-2 text-sm">
        ...
        <div className="mt-8 rounded-lg border border-blue-200 bg-blue-50 p-4">
          <h4 className="mb-2 font-semibold text-blue-800">🎯 Assessment Methodology</h4>
          <div className="space-y-2 text-sm text-blue-700">
            <p>
              <strong>Pass:</strong> Feature works correctly as expected
            </p>
            <p>
              <strong>Fail:</strong> Feature is broken or has critical issues
            </p>
            <p>
              <strong>Warning:</strong> Feature works but has minor issues or concerns
            </p>
            <p>
              <strong>Untested:</strong> Feature needs to be tested
            </p>
          </div>
        </div>

        <div className="mt-4 rounded-lg border border-red-200 bg-red-50 p-4">
          <h4 className="mb-2 font-semibold text-red-800">🚨 Critical Issues Identified</h4>
          <ul className="space-y-1 text-sm text-red-700">
            <li>
              • <strong>Agent Property Visibility:</strong> Agents can see all properties instead of
              only assigned ones
            </li>
            <li>
              • <strong>Security Concern:</strong> Potential privacy/security issue with property
              access
            </li>
            <li>
              • <strong>Role-Based Access:</strong> Need to implement proper RLS policies for
              property visibility
            </li>
          </ul>
        </div>
