...
export const SmartRoleSelection: React.FC<SmartRoleSelectionProps> = ({
  ...
  const [validation, setValidation] = useState<{ isValid: boolean; message?: string; suggestedAlternative?: UserRole } | null>(null);
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <p className="text-sm text-blue-700">
                    Based on your information, we suggest: <strong>{roleDescriptions[suggestion.suggestedRole].title}</strong>
                  </p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-green-800">
                    Great choice! As a {roleDescriptions[selectedRole].title.toLowerCase()}, you'll have access to:
                  </p>
