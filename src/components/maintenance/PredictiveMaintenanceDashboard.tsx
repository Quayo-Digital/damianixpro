    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">AI-powered maintenance insights and predictions</p>
        </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {getCategoryIcon(alert.category)} {alert.category} • Due in{' '}
                          {getDaysUntil(alert.predicted_failure_date)} days
                        </p>
                      </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Scheduled tasks for the next 30 days</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {equipment.slice(0, 6).map((item) => (
                  <div key={item.id} className="rounded-lg border p-4">
                    <div className="mb-2 flex items-center justify-between">
                      ...
                      <Badge
                        ...
                        className={getRiskLevelColor(
                          item.current_condition === 'critical'
                            ? 'critical'
                            : item.current_condition === 'poor'
                              ? 'high'
                              : item.current_condition === 'fair'
                                ? 'moderate'
                                : 'low'
                        )}
                      >
                    ...
                    <Progress
                      value={
                        item.current_condition === 'excellent'
                          ? 95
        ...
        <TabsContent value="schedule" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Planned maintenance tasks and their schedules</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {schedule.map((task) => (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                        <span>
                          Category: {getCategoryIcon(task.category)} {task.category}
                        </span>
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium">Next Due: {formatDate(task.next_due)}</p>
                      <p className="text-xs text-muted-foreground">
        ...
        <TabsContent value="insights" className="space-y-4">
          <div className="space-y-4">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="mb-2 flex items-center space-x-2">
                        ...
                        <Badge variant="outline">Impact: {insight.impact_score}/100</Badge>
                      </div>
                      ...
                      <div className="flex items-center space-x-4 text-sm">
                        ...
                        <span>Timeline: {insight.recommended_timeline}</span>
                      </div>
                    </div>
                    <Badge
                      variant={
                        insight.insight_type === 'cost_optimization' ? 'default' : 'secondary'
                      }
                    >
            ...
            {insights.length === 0 && (
              <Card>
                <CardContent className="p-12 text-center">
                  <Lightbulb className="mx-auto mb-4 h-12 w-12 text-yellow-600" />
          ...
          {analytics ? (
                  ...
                  <div className="space-y-3">
                    {analytics.equipment_health.map((item, index) => (
                      <div key={index} className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          <Progress value={item.health_score} className="h-2 w-20" />
                          <Badge variant="outline" className={getRiskLevelColor(item.risk_level)}>
                            {item.risk_level}
                          </Badge>
                        </div>
                      </div>
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <h3 className="mb-2 text-lg font-semibold">Analytics Loading</h3>
                <p className="text-muted-foreground">
