  ...
  return (
    <PageLayout>
      <PageContent
        ...
        description="Comprehensive security audit and performance monitoring for DamianixPro platform"
      >
        <div className="space-y-6">
          ...
          <Alert>
            ...
            <AlertDescription>
              This comprehensive monitoring system provides real-time security auditing and
              performance optimization specifically designed for the Nigerian market. It includes
              network-aware optimizations for 2G/3G connections and security configurations for
            ...
            <Alert>
              ...
              <AlertDescription>
                <ul className="mt-2 space-y-1 text-sm">
                  ...
                  <li>• Nigerian payment gateway security (Flutterwave)</li>
          ...
          <Alert>
            ...
            <AlertDescription>
              <div className="mt-2 space-y-2 text-sm">
                <p>
                  <strong>1. Overview Tab:</strong> Get a quick health summary of security and
                  performance metrics
                </p>
                <p>
                  <strong>2. Security Tab:</strong> Run comprehensive security audits and view
                  detailed test results
                </p>
                <p>
                  <strong>3. Performance Tab:</strong> Monitor Core Web Vitals and network-specific
                  performance metrics
                </p>
                <p>
                  <strong>4. Events Tab:</strong> View detailed security event logs with severity
                  tracking
                </p>
                <p>
                  <strong>5. Tools Tab:</strong> Access utility functions for testing and
                  optimization
                </p>
                <p className="mt-3 font-medium">
                  💡 Click "Run Full Audit" to perform a comprehensive security and performance
                  assessment.
                </p>
              </div>
            </AlertDescription>
