...
const AdminSetup = () => {
  ...
  return adminCreated ? (
    <div className="flex min-h-screen flex-col items-center justify-center bg-secondary/50 p-4">
      <div className="w-full max-w-5xl rounded-lg bg-background p-8 shadow-lg">
        <div className="mb-6 flex items-center justify-between">
          ...
          <Badge
            variant="outline"
            className="flex items-center gap-1.5 border-amber-300 bg-amber-50 text-amber-800"
          >
        ...
        <Tabs value={currentTab} onValueChange={setCurrentTab} className="mb-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  ...
                  Functionality to modify user roles, reset passwords, and view user activities
          ...
          <TabsContent value="system">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  This section would include global settings like email notifications, system
                  maintenance, backup scheduling, and other administrative controls.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="logs">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  This section would display comprehensive logs of all system activities, including
                  user actions, system events, and error reports with filtering options.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-secondary/50 p-4">
      <div className="w-full max-w-md rounded-lg bg-background p-8 shadow-lg">
        ...
        <h1 className="mb-2 text-center text-2xl font-bold">Admin Setup</h1>
        <p className="mb-6 text-center text-muted-foreground">
          Grant admin privileges to your account
        </p>

        {!user ? (
          <div className="mb-6 rounded-md border border-amber-200 bg-amber-50 p-4 text-center">
          ...
          <>
            <div className="mb-6 rounded-md bg-slate-100 p-4">
              <p className="text-sm">
                This will grant admin privileges to your current account ({user.email}). Admins have
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will grant you administrator privileges to the entire system. You will
                      have access to all features and data. Are you sure you want to proceed?
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    <AlertDialogCancel>Cancel</AlertDialogCancel>
                    <AlertDialogAction onClick={promoteToAdmin} disabled={isLoading}>
