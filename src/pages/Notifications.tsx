...
import {
  NotificationEngineHints,
  NotificationEngineInfoCard,
} from '@/components/notifications/NotificationEngineHints';
...
export default function Notifications() {
  ...
  const markOneRead = useMutation({
    mutationFn: async (id: string) => markNotificationAsRead(user!.id, id),
    onSuccess: () => {
  ...
  return (
    <PageLayout>
      <PageContent
        title="Notifications"
        description="Stay on top of payments, maintenance, and lease updates."
      >
        <NotificationEngineInfoCard />
        {error && (
